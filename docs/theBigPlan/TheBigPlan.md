...
- Sales CRUD UI: Stores, SalesPersons, Customers (API prerequisite now satisfied by completed Phase 2.5)
  ...
  - ✅ US-733: SalesPerson detail view (`SalesPersonDetailComponent`) — tabbed detail with lazy-loaded performance tab (2026-06-10)
  - ✅ US-734: SalesPerson create form (`SalesPersonCreateComponent`) — four-tab reactive form with direct API call, forkJoin reference data load, and tab error badge pattern (2026-06-10)
  - ✅ US-735: SalesPerson edit form (`SalesPersonEditComponent`) — sales config PATCH at `/sales/persons/:id/edit`, forkJoin load, `isSaving` guard, direct API call (2026-06-15)
  - ✅ US-736: Sales order list view (`libs/sales/feature-orders`, Feature #712) — server-side paginated, five-field filter bar, sortable order list at `/sales/orders` with full URL-param sync (2026-06-19)
    - ✅ US-737: Sales order detail view (`OrderDetailComponent`) — read-only order detail at `/sales/orders/:id`, direct `SalesApiService` call, no NgRx store (2026-06-23)
    - ⬜ US-738: URL-param sync for filters/sort/page — **largely satisfied by US-736**, which implemented the full sync (all 5 filters + page + sort, `queryParamsHandling: 'merge'`) ahead of schedule; only confirmation/edge-case work likely remains
...
| Feature                     | ID   | Stories       | Notes                        |
| --------------------------- | ---- | ------------- | ---------------------------- |
| Production Lookup Endpoints | #913 | #914-#917 (4) | ✅ Done 2026-05-17           |
| Sales Lookup Endpoints      | #918 | #919-#922 (4) | ✅ Done 2026-05-07           |
...
| Angular SignalR client: auto-reconnect + connection state | #777 | US-791, US-792, US-793 | ✅ Done | 2026-06-08 |
...
**Status**: Active Execution — Epic #560 complete, #570 complete, **#577 complete** (Done 2026-05-25; all 6 features done including #621 SignalR), #552 closed Done, **#873 API Completion complete** (Done in ADO on 2026-05-22; all 17 child Features Done; US-727 Sales Dashboard KPI endpoint added post-close), #565 in progress (2/5 features done: #669, #923), **Phase 5 in progress** (US-728 Store List done 2026-06-02; US-729 Store Detail done 2026-06-02; US-730 Store Create done 2026-06-03; US-731 Store Edit done 2026-06-03; US-732 SalesPerson List done 2026-06-08; US-733 SalesPerson Detail done 2026-06-10; US-734 SalesPerson Create done 2026-06-10; US-735 SalesPerson Edit done 2026-06-15; US-736 Sales Order List done 2026-06-19 — pulled US-738 URL-param sync forward; US-737 Sales Order Detail done 2026-06-23), **Epic #563 in progress** (Feature #773 SignalR Hub enabler done 2026-06-05: US-778, US-779, US-780; Feature #777 Angular SignalR client done 2026-06-08: US-791 MSAL auth, US-792 auto-reconnect + connection state signal, US-793 typed event registration + lifecycle teardown) — **Next: Continue Phase 5 Sales & HR CRUD UI (Epics #561, #562) + Epic #563 Real-Time Dashboard + Epic #565 remaining testing features**
