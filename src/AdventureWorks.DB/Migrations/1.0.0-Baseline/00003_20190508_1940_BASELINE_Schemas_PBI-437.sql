-- <Migration ID="17245b2e-2319-4ec7-9cb5-2b08da2e2172" />
GO
/****************************************************************************************************************
...
IF SCHEMA_ID(N'Demo') IS NULL
	EXEC sys.sp_executesql @stmt = N'CREATE SCHEMA [Demo] AUTHORIZATION [dbo]'

IF SCHEMA_ID(N'HumanResources') IS NULL
	EXEC sys.sp_executesql @stmt = N'CREATE SCHEMA [HumanResources] AUTHORIZATION [dbo]'

IF SCHEMA_ID(N'Person') IS NULL
	EXEC sys.sp_executesql @stmt = N'CREATE SCHEMA [Person] AUTHORIZATION [dbo]'

IF SCHEMA_ID(N'Production') IS NULL
	EXEC sys.sp_executesql @stmt = N'CREATE SCHEMA [Production] AUTHORIZATION [dbo]'

IF SCHEMA_ID(N'Purchasing') IS NULL
	EXEC sys.sp_executesql @stmt = N'CREATE SCHEMA [Purchasing] AUTHORIZATION [dbo]'

IF SCHEMA_ID(N'Sales') IS NULL
	EXEC sys.sp_executesql @stmt = N'CREATE SCHEMA [Sales] AUTHORIZATION [dbo]'

IF SCHEMA_ID(N'Security') IS NULL
	EXEC sys.sp_executesql @stmt = N'CREATE SCHEMA [Security] AUTHORIZATION [dbo]'
