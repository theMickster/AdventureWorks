...
/**
 * Extracts the sales-persons list navigation params (search, pageNumber, orderBy, sortOrder) from a
 * route snapshot so the detail page can reconstruct the exact list URL on back-navigation.
