...
export class SalesApiService {
  ...
  /** Fetches quota history, territory history, and order aggregates for a single sales person. */
  getSalesPersonPerformance(id: number): Observable<SalesPersonPerformance> {
    return this.apiService.get<SalesPersonPerformance>(`/v1/salespersons/${id}/performance`);
  }
