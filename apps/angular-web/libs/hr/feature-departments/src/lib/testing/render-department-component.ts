...
/** Result of {@link renderDepartmentComponent}. */
export interface RenderDepartmentComponentResult<T> {
 ...
 * `@nx/enforce-module-boundaries`. None of the department components inject `AuthService`,
 ...
 */
export async function renderDepartmentComponent<T>(
  component: Type<T>,
  providers: Provider[] = [],
): Promise<RenderDepartmentComponentResult<T>> {
