...
/** Result of {@link renderHistoryComponent}. */
export interface RenderHistoryComponentResult<T> {
 ...
 * `@nx/enforce-module-boundaries`. None of the history components inject `AuthService`,
 ...
 */
export async function renderHistoryComponent<T>(
  component: Type<T>,
  providers: Provider[] = [],
): Promise<RenderHistoryComponentResult<T>> {
