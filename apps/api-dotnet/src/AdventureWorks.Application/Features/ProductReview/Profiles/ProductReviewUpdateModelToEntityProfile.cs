...
/// <summary>
/// AutoMapper profile for mapping ProductReviewUpdateModel onto an existing ProductReview entity.
/// </summary>
public sealed class ProductReviewUpdateModelToEntityProfile : Profile
{
    public ProductReviewUpdateModelToEntityProfile()
    {
        CreateMap<ProductReviewUpdateModel, Domain.Entities.Production.ProductReview>()
