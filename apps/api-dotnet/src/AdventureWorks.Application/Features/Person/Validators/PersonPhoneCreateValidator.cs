...
/// <summary>
/// Validates the payload for creating a new person phone number.
...
/// </summary>
public sealed class PersonPhoneCreateValidator : AbstractValidator<PersonPhoneCreateModel>
{
    public PersonPhoneCreateValidator()
    {
