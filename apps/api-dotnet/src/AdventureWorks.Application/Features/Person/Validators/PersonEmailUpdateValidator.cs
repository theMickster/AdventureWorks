...
/// <summary>
/// Validates the payload for updating a person email address.
...
/// </summary>
public sealed class PersonEmailUpdateValidator : AbstractValidator<PersonEmailUpdateModel>
{
    public PersonEmailUpdateValidator()
    {
