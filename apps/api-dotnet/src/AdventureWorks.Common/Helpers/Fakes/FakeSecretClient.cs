...
{
    public override Response<KeyVaultSecret> GetSecret(string name, string? version, SecretContentType? outContentType, CancellationToken cancellationToken = default)
    {
    ...
    {
        return GetSecret(name, version, null, cancellationToken);
    }
    ...
    {
        return GetSecretAsync(name, version, null, cancellationToken);
    }
}
