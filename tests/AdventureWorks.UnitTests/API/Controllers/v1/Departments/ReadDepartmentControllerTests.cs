...
public sealed class ReadDepartmentControllerTests : UnitTestBase
{
    ...
    public async Task GetList_returns_ok_Async()
    {
        _mockMediator.Setup(
            ...
            .ReturnsAsync(
            [
                new() { Id = 1, Name = "Engineering", GroupName = "Research and Development" },
                new() { Id = 2, Name = "Tool Design", GroupName = "Research and Development" },
                new() { Id = 3, Name = "Sales", GroupName = "Sales and Marketing" }
            ]);
