...
public sealed class UpdateStoreValidatorTests : UnitTestBase
{
    ...
    {
        UpdateStoreValidator.MessageStoreNameEmpty.Should().Be("Store name cannot be null, empty, or whitespace");
        UpdateStoreValidator.MessageStoreNameLength.Should().Be("Store name cannot be greater than 50 characters");
    }
